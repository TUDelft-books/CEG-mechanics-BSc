...
This <a href="https://teachbooks.tudelft.nl/"><img height="20px" src="./images/Logo_without_background.png"></img>TeachBook</a> combines all sources into modules, breaking down each module into separate parts of theory and skills including exercises. This TeachBook links heavily to relevant part of the other literature and only provides additional content when the other literature is insufficient.
...
- Additional exercises in [<img height="12px" src="./images/ANS.svg" alt="ANS">](https://ans.app/)
