...
- Introduction to continuum mechanics, by {cite:ts}`Hartsuijker2007con`.
  - Book available [here](Lecture_Notes_Elasticity.pdf).
- Niet-symmetrische en inhomogene doorsnedes, by {cite:ts}`Hartsuijker2009`.
  - Book available [here](Niet-symmetrische_en_inhomogene_doorsnedes.pdf).
